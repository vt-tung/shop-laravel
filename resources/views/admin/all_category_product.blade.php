...
@section('admin_content')
  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
     ...
     <?php
        $message = Session::get('messageCategory');
        if($message){
          ?>
          ...
          <?php
          Session::put('messageCategory',null);
        }
    ?>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Are you sure?')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="">
